...
import ImageBannerItem from "../components/intro/ImageBannerItem";

export default {
  title: "Intro/ImageBannerItem",
  component: ImageBannerItem,
} as ComponentMeta<typeof ImageBannerItem>;

const Template: ComponentStory<typeof ImageBannerItem> = (args) => (
  <ImageBannerItem {...args} />
);

export const About: ComponentStory<typeof ImageBannerItem> = Template.bind({});
About.args = {
...
export const Subway: ComponentStory<typeof ImageBannerItem> = Template.bind({});
Subway.args = {
  imageUrl: "/images/banner_image01.png",
...
export const Request: ComponentStory<typeof ImageBannerItem> = Template.bind(
  {}
);
Request.args = {
